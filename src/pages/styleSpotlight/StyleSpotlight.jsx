...
import SpotlightComment from '../index/spotlightcomment/SpotlightComment';
...
const StyleSpotlight = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-100 py-10 px-4">
      <h1 className="text-4xl font-bold text-center text-[#959A4A] mb-6">
        Style Spotlight
      </h1>
        ...
        {loading ? (
          ...
          paginatedData.map((artist, idx) => (
            ...
            >
              ...
              />
              <div className="p-4">
                <h2 className="text-xl font-semibold text-[#959A4A]">
                  {artist.name}
                </h2>
      ...
      {/* ✅ Comment only for featured spotlight (by ID now) */}
